...
const quarters = [
  ...
  '2021  Summer Session 2',
  '2021  Summer Qtr (COM)',
  '2021  10-wk Summer',
  '2021  Summer Session 1',
  '2021  Spring Quarter',
  '2021  Winter Quarter',
  '2020  Fall Quarter',
  ...
  '2018  Winter Quarter',
  '2017  Fall Quarter',
  '2017  Summer Session 2',
  '2017  Summer Qtr (COM)',
  '2017  10-wk Summer',
  '2017  Summer Session 1',
  '2017  Spring Quarter',
  '2017  Winter Quarter',
  '2016  Fall Quarter',
...
function getQuarterColor(quarter) {
  if (
    (quarter.indexOf('Fall') !== -1 && quarter.indexOf('Law') === -1) ||
    quarter.indexOf('Winter') !== -1 ||
